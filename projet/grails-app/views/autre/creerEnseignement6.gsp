...
<body>
	...
	<form id="form" action="cgi/form.cgi">
		...
		<p>
			<input type="checkbox" name="composant" value="salami">
			Salami<br> <input type="checkbox" name="composant"
				value="champignons"> champignons<br> <input
				type="checkbox" name="composant" value="anchois"> anchois
		</p>
	</form>
